...
**Фаза:** 1 — авторизация
**Следующая задача:** 1.2 (роуты авторизации)
**Блокеры:** нет
...
- [x] 1.1 — Модель User: схема, bcrypt pre-save, comparePassword(), generateToken()
...
_21.03.2026 — Фаза 0 завершена. Начата фаза 1: модель User создана (1.1). Локальная проверка отложена._
